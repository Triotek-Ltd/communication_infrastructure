...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount'}, 'search_fields': ['title', 'reference_no', 'description', 'message_code', 'gateway', 'direction'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'created', 'lifecycle_states': ['created', 'queued', 'sent', 'delivered', 'bounced', 'failed', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'queue': None, 'send': None, 'retry': None, 'fail': None, 'archive': 'archived'}}
