"""Business-domain service seed for Email Message Record."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['created', 'queued', 'sent', 'delivered', 'bounced', 'failed', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'related_email_delivery_event': 'relation_collection', 'related_email_template_binding': 'relation_collection', 'related_correspondence_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'message_code', 'gateway', 'direction'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'created', 'lifecycle_states': ['created', 'queued', 'sent', 'delivered', 'bounced', 'failed', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'queue': None, 'send': None, 'retry': None, 'fail': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['email_gateway', 'email_delivery_event', 'email_template_binding', 'correspondence_record'], 'action_targets': {'create': None, 'queue': None, 'send': None, 'retry': None, 'fail': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
