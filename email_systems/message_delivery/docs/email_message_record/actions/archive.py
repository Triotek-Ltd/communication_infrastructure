"""Action handler seed for email_message_record:archive."""
...
ACTION_ID = "archive"
ACTION_RULE = {'allowed_in_states': ['created', 'queued', 'sent', 'delivered', 'bounced', 'failed'], 'transitions_to': 'archived'}
