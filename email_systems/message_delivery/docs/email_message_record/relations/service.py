"""Relation service seed for email_message_record."""
...
RELATED_DOCS = [{'doc_id': 'email_gateway', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'email_delivery_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'email_template_binding', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'correspondence_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'gateway identity from email_gateway'}, {'description': 'template refs from email_template_binding'}]
