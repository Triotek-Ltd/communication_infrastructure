"""Business-domain service seed for Email Gateway."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'active_status': 'status_flag', 'related_email_message_record': 'relation_collection', 'related_email_delivery_event': 'relation_collection', 'related_email_template_binding': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'gateway_code', 'provider_identity', 'sender_domain_or_mailbox_scope'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'verified', 'active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'verify': None, 'activate': 'active', 'disable': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {'relation_context': {'related_docs': ['email_message_record', 'email_delivery_event', 'email_template_binding'], 'borrowed_fields': ['sender domain/mailbox from account setup where linked'], 'inferred_roles': ['operations coordinator']}, 'actors': ['operations coordinator'], 'action_actors': {'create': ['operations coordinator'], 'verify': ['operations coordinator'], 'activate': ['operations coordinator'], 'archive': ['operations coordinator']}}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['email_message_record', 'email_delivery_event', 'email_template_binding'], 'action_targets': {'create': None, 'verify': None, 'activate': 'active', 'disable': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

class DomainService:
    doc_id = "email_gateway"
