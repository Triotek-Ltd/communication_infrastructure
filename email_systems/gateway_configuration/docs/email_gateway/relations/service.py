"""Relation service seed for email_gateway."""
...
RELATED_DOCS = [{'doc_id': 'email_message_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'email_delivery_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'email_template_binding', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'sender domain/mailbox from account setup where linked'}]
