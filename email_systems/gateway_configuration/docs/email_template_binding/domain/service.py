"""Business-domain service seed for Email Template Binding."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'active_status': 'status_flag', 'related_email_message_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'binding_code', 'gateway', 'internal_template_key'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'review': None, 'activate': 'active', 'archive': 'archived'}}

WORKFLOW_HINTS = {}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['email_gateway', 'email_message_record'], 'action_targets': {'create': None, 'update': None, 'review': None, 'activate': 'active', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

class DomainService:
    doc_id = "email_template_binding"
