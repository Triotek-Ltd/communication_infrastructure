"""Relation service seed for email_template_binding."""
...
RELATED_DOCS = [{'doc_id': 'email_gateway', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'email_message_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'gateway identity from email_gateway'}]
