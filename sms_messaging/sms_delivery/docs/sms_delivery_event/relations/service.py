"""Relation service seed for sms_delivery_event."""
...
RELATED_DOCS = [{'doc_id': 'sms_message_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sms_gateway', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
