"""Relation service seed for sms_message_record."""
...
RELATED_DOCS = [{'doc_id': 'sms_gateway', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sms_delivery_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'service_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'gateway identity from sms_gateway'}]
