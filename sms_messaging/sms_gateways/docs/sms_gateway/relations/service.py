"""Relation service seed for sms_gateway."""
...
DOC_ID = "sms_gateway"
RELATED_DOCS = [{'doc_id': 'sms_message_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sms_delivery_event', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'sender context from communication setup'}]
