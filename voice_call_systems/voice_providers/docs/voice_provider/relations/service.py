"""Relation service seed for voice_provider."""
...
RELATED_DOCS = [{'doc_id': 'call_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'call_event_log', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'number/trunk context from telephony setup where linked'}]
