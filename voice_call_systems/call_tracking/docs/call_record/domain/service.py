"""Business-domain service seed for Call Record."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['initiated', 'ringing', 'answered', 'missed', 'failed', 'completed', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'call_status': 'status_flag', 'related_call_event_log': 'relation_collection', 'related_service_case': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'call_code', 'provider', 'direction'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'initiated', 'lifecycle_states': ['initiated', 'ringing', 'answered', 'missed', 'failed', 'completed', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'ring': None, 'answer': None, 'complete': None, 'fail': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['voice_provider', 'call_event_log', 'service_case'], 'action_targets': {'create': None, 'ring': None, 'answer': None, 'complete': None, 'fail': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
