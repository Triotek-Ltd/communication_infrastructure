"""Relation service seed for call_record."""
...
DOC_ID = "call_record"
RELATED_DOCS = [{'doc_id': 'voice_provider', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'call_event_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'service_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'provider'}, {'description': 'number context from voice_provider'}]
