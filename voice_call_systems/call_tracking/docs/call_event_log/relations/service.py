"""Relation service seed for call_event_log."""
...
RELATED_DOCS = [{'doc_id': 'call_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'voice_provider', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'provider/call context from linked records'}]
