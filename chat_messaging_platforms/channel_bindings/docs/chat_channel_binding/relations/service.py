"""Relation service seed for chat_channel_binding."""
...
RELATED_DOCS = [{'doc_id': 'chat_message_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'chat_session_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'tenant/account context from communication setup'}]
