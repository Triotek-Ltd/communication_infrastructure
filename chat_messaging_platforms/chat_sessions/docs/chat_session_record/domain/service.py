"""Business-domain service seed for Chat Session Record."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'assigned', 'active', 'closed', 'reopened', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'session_opened_at': 'schedule_marker', 'session_status': 'status_flag', 'related_chat_message_record': 'relation_collection', 'related_service_case': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'session_code', 'channel_binding', 'participants'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'assigned', 'active', 'closed', 'reopened', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': None, 'reply': None, 'close': 'closed', 'reopen': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['chat_channel_binding', 'chat_message_record', 'service_case'], 'action_targets': {'create': None, 'assign': None, 'reply': None, 'close': 'closed', 'reopen': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
