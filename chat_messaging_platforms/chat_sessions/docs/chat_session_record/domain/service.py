...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'session_opened_at': 'schedule_marker', 'session_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'session_code', 'channel_binding', 'participants'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'assigned', 'active', 'closed', 'reopened', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': None, 'reply': None, 'close': 'closed', 'reopen': None, 'archive': 'archived'}}
