"""Relation service seed for chat_message_record."""
...
RELATED_DOCS = [{'doc_id': 'chat_channel_binding', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'chat_session_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'channel/account context from chat_channel_binding'}]
