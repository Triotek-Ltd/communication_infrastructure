"""Business-domain service seed for Chat Message Record."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['received', 'created', 'sent', 'delivered', 'read', 'failed', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'related_chat_session_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'message_code', 'channel_binding', 'direction'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'received', 'lifecycle_states': ['received', 'created', 'sent', 'delivered', 'read', 'failed', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'send': None, 'deliver': None, 'fail': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['chat_channel_binding', 'chat_session_record'], 'action_targets': {'create': None, 'send': None, 'deliver': None, 'fail': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
